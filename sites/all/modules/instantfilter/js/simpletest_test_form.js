(function ($, Drupal) {
  ...
  /**
   * Filters the simpletest list table by a text input search string.
   *
    ...
    attach: function (context, settings) {
      ...
      function filterTestList(e) {
        ...
        function showTestRow(index, row) {
          ...
          if (textMatch) {
            $row.closest('tr').prevAll('tr.simpletest-group:first').toggle(textMatch);
          }
        }
      ...
      if ($table.length) {
        ...
        $input.bind('input', filterTestList);
      }
